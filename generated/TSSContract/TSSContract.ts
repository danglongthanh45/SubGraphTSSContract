...
export class AddBlacklistEvent extends ethereum.Event {
  get params(): AddBlacklistEvent__Params {
    return new AddBlacklistEvent__Params(this);
  }
}

export class AddBlacklistEvent__Params {
  _event: AddBlacklistEvent;

  constructor(event: AddBlacklistEvent) {
    this._event = event;
  }
...
export class RemoveBlacklistEvent extends ethereum.Event {
  get params(): RemoveBlacklistEvent__Params {
    return new RemoveBlacklistEvent__Params(this);
  }
}

export class RemoveBlacklistEvent__Params {
  _event: RemoveBlacklistEvent;

  constructor(event: RemoveBlacklistEvent) {
    this._event = event;
  }
...
export class TSSContract extends ethereum.SmartContract {
  static bind(address: Address): TSSContract {
    return new TSSContract("TSSContract", address);
  }
  ...
  isBlacklist(param0: Address): boolean {
    let result = super.call("isBlacklist", "isBlacklist(address):(bool)", [
  ...
  try_isBlacklist(param0: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall("isBlacklist", "isBlacklist(address):(bool)", [
      ethereum.Value.fromAddress(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
...
export class AddBlacklistCall__Inputs {
  ...
  get _blacklistAddresses(): Array<Address> {
...
export class SetUriNftCall extends ethereum.Call {
  get inputs(): SetUriNftCall__Inputs {
    return new SetUriNftCall__Inputs(this);
  }

  get outputs(): SetUriNftCall__Outputs {
    return new SetUriNftCall__Outputs(this);
  }
}

export class SetUriNftCall__Inputs {
  _call: SetUriNftCall;

  constructor(call: SetUriNftCall) {
    this._call = call;
  }
...
export class SetUriNftCall__Outputs {
  _call: SetUriNftCall;
